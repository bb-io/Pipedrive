...
public class OrganizationDataHandler : BaseInvocable, IAsyncDataSourceHandler
{
    ...
    {
        var actions = new OrganizationActions();
        var activities = await actions.ListOrganizations(Creds);
