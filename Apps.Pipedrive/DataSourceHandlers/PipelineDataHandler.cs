...
public class PipelineDataHandler : BaseInvocable, IAsyncDataSourceHandler
{
    ...
    {
        var actions = new PipelineActions();
        var activities = await actions.ListPipelines(Creds);

        return activities.Pipelines
